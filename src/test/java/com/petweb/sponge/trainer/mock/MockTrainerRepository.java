...
public class MockTrainerRepository implements TrainerRepository {
    ...
    private final List<History> historyData = new CopyOnWriteArrayList<>();
    private final List<TrainerAddress> trainerAddressData = new CopyOnWriteArrayList<>();
    ...
    public Trainer save(Trainer trainer) {
        ...
        if(trainer.getId()==null || trainer.getId() == 0) {
            ...
            trainerAddressData.addAll(trainer.getTrainerAddressList());
            historyData.addAll(trainer.getHistoryList());
            return newTrainer;
        }
        else {
